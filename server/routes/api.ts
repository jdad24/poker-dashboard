...
router.get('/players', async (_req: Request, res: Response) => {
    ...
    try {
        ...
        console.error(e)
        return []
        // return res.status(500).json({ success: false, message: 'Error fetching players' })
    }
});

router.get('/players/transactions', async (_req: Request, res: Response) => {
    ...
    try {
        ...
        console.error(e)
        return []
        // return res.status(500).json({ success: false, message: 'Error fetching player transactions' })
    }
});
...
router.get('/dealers/sessions', async (_req: Request, res: Response) => {
